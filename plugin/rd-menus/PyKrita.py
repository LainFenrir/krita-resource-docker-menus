...
@param values the QVector containing the new channel/component values. These should be normalized. """
	...
	def toXML(self) -> str:
		# type: () -> str:
		"""@access public 
 Serialize this color following Create's swatch color specification available at https://web.archive.org/web/20110826002520/http://create.freedesktop.org/wiki/Swatches_-_colour_file_format/Draft """

	def fromXML(self, xml: str) -> None:
		# type: (xml) -> None:
		"""@access public 
 Unserialize a color following Create's swatch color specification available at https://web.archive.org/web/20110826002520/http://create.freedesktop.org/wiki/Swatches_-_colour_file_format/Draft
